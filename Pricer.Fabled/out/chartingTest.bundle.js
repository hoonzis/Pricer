...
/***/ function(module, exports, __webpack_require__) {
	...
	function randomValues() {
	    return Array.from(_fableCore.Seq.map(function (i) {
	        return new _Charting.DateScatterValue(_fableCore.Date.create(2014, i, 1), ~~((Math.floor(Math.random() * (2147483647 - 0)) + 0) / 100000), Math.floor(Math.random() * (2147483647 - 0)) + 0);
	    }, Int32Array.from(_fableCore.Seq.range(1, 10))));
	}
...
/***/ }
/******/ ]);
//# sourceMappingURL=chartingTest.bundle.js.map