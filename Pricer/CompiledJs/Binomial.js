(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(["exports", "fable-core", "./Options"], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require("fable-core"), require("./Options"));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.fableCore, global.Options);
    global.unknown = mod.exports;
  }
})(this, function (exports, _fableCore, _Options) {
  "use strict";
      ...
      return function () {
        ...
        for (var step = counter; step <= 0; step++) {
          for (var j = 0; j <= step; j++) {
            ...
            _fableCore.Util.compareTo(pricing.Option.Style, new _Options.OptionStyle("American")) === 0 ? (prices[j] = pricing.Down * prices[j + 1], oValues[j] = oValues[j] > optionValue(j) ? oValues[j] : optionValue(j)) : null;
          }
        }

        var delta = (oValues[1] - oValues[1]) / (pricing.Ref * pricing.Up - pricing.Ref * pricing.Down);
        var Premium = oValues[0];
        return new _Options.Pricing(delta, Premium);
      }();
    };
    ...
    var binomialPricingFunc = $exports.binomialPricingFunc = function (pricing) {
      ...
      return optionValue = function () {
        ...
        return option = pricing.Option, function (stockPrice) {
          return _Options.Options.optionValue(option, stockPrice);
        };
      ...
      }, premium = reducePrices(prices), new _Options.Pricing(1, premium);
    };
