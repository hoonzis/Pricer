(function (global, factory) {
  ...
  var BsPricer = exports.BsPricer = function () {
    function BsPricer(math) {
      _classCallCheck(this, BsPricer);

      this.math = math;
    }

    _createClass(BsPricer, [{
      key: "blackScholes",
      ...
      key: "cashPricing",
      value: function cashPricing(leg) {
        var Premium;
        return Premium = leg.Price, new _OptionsModel.Pricing(1, Premium);
      }
    }, {
      key: "convertiblePricing",
      value: function convertiblePricing(stock, leg) {
        var Premium;
        return Premium = leg.ReferencePrice, new _OptionsModel.Pricing(0.45, Premium);
      }
    }]);
