...
type LseStocks = JsonProvider<"lsedataset.json">
type SingleLseStock = JsonProvider<"lsesinglestock.json">
type SingleEuroNextStock = JsonProvider<"euronextsinglestock.json">
